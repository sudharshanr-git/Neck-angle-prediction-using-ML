This project aims to prove that Machine learning models can be trained and used to predict the neck turn angle by, taking video from camera of any computing device as input.
